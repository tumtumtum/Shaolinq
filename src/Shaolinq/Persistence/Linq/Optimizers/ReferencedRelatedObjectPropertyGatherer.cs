		...
		: SqlExpressionVisitor
	{
		...
		protected override Expression VisitMethodCall(MethodCallExpression methodCallExpression)
		{
				...
				&& methodCallExpression.Method.GetGenericMethodDefinition() == MethodInfoFastRef.DataAccessObjectExtensionsIncludeMethod)
			{
				...
				var selector = (LambdaExpression)methodCallExpression.Arguments[1];				var newSelector = ExpressionReplacer.Replace(selector.Body, selector.Parameters[0], methodCallExpression.Arguments[0]);
